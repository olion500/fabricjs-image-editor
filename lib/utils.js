 ...
 */
export const generateFabricGradientFromColorStops = (handlers, width, height, orientation, angle) => {
 ...
 */
export const alignObject = (canvas, activeSelection, pos) => {
  switch (pos) {
    case 'left':
...
export const downloadImage = (data, extension = 'png', mimeType = 'image/png') => {
