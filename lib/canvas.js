...
(function () {
  ...
  var canvas = function () {
    try {
      $(`${this.containerSelector} .main-panel`).append(`<div class="canvas-holder" id="canvas-holder"><div class="content"><img id="background-picture" /><canvas id="c"></canvas></div></div>`);
